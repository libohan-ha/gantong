...
export class GrowthProfile {
  ...
  // Physical
  @Column({ name: 'height_cm', type: 'numeric', precision: 5, scale: 2, nullable: true, transformer: { to: (v: number | null) => v, from: (v: string | null) => (v === null ? null : Number(v)) } })
  heightCm: number | null

  @Column({ name: 'weight_kg', type: 'numeric', precision: 5, scale: 2, nullable: true, transformer: { to: (v: number | null) => v, from: (v: string | null) => (v === null ? null : Number(v)) } })
  ...
  // Behavior tags
  @Column({ name: 'behavior_strengths', type: 'text', array: true, default: '{}' })
  behaviorStrengths: string[]

  @Column({ name: 'behavior_challenges', type: 'text', array: true, default: '{}' })
  behaviorChallenges: string[]

  @Column({ name: 'behavior_improvements', type: 'text', array: true, default: '{}' })
