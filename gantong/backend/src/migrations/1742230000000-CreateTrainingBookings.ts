...
export class CreateTrainingBookings1742230000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."training_bookings_status_enum" AS ENUM('submitted','canceled')`)
    ...
    await queryRunner.query(`CREATE INDEX "idx_tb_training_created" ON "training_bookings" ("training_id","created_at")`)
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "idx_tb_training_created"`)
    await queryRunner.query(`ALTER TABLE "training_bookings" DROP CONSTRAINT "FK_tb_training"`)
    await queryRunner.query(`ALTER TABLE "training_bookings" DROP CONSTRAINT "FK_tb_doctor"`)
    await queryRunner.query(`ALTER TABLE "training_bookings" DROP CONSTRAINT "FK_tb_parent"`)
    await queryRunner.query(`DROP TABLE "training_bookings"`)
    await queryRunner.query(`DROP TYPE "public"."training_bookings_status_enum"`)
  }
}
